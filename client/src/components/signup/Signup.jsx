...
const Signup = () => {
  ...
  const handleSignup = async(e) => {
    e.preventDefault()
    try {
      const res = await fetch(`https://dream-food-media.onrender.com/auth/register`, {
        headers: {
      ...
      <div className={classes.signUpWrapper}>
        ...
        <div className={classes.signUpRightSide}>
          ...
          <form onSubmit={handleSignup} className={classes.signUpForm}>
            <input type="text" placeholder="Type username" value={username} onChange={(e) => setUsername(e.target.value)}/>
